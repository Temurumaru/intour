						...
						<div class="bg-secondary rounded h-100 p-4">
							<form action="{{route('addPostOnBlogC')}}" enctype="multipart/form-data" method="post">
								...
								<div class="form-floating mb-3">
									<input type="text" name="title_ru" class="form-control" id="floatingInput"
										placeholder="Title" value="{{$data -> title_ru}}">
									<label for="floatingInput">Title RU</label>
								</div>
								<div class="mb-3">
									<label for="formFile" class="form-label">Walpaper image</label>
									<input class="form-control bg-dark" name="wallpaper_img" type="file" id="asdf" value="{{$data -> wallpaper}}" id="formFile">
								</div>
								<div class="mb-3">
									<label for="formFile" class="form-label">Preview image</label>
									<input class="form-control bg-dark" name="preview_img" type="file" value="{{$data -> preview}}" id="formFile">
								</div>
								<div class="form-floating">
									<textarea class="form-control" placeholder="Leave a comment here"
										id="floatingTextarea" name="top_text" style="height: 150px;">{{$data -> top_text}}</textarea>
									<label for="floatingTextarea">Top text</label>
								</div>
								<div class="form-floating mt-2">
									<textarea class="form-control" placeholder="Leave a comment here"
										id="floatingTextarea" name="top_text_ru" style="height: 150px;">{{$data -> top_text_ru}}</textarea>
									<label for="floatingTextarea">Top text RU</label>
								</div>
								<div class="mt-3 mb-4">
								...
								<div class="form-floating">
									<textarea class="form-control" placeholder="Leave a comment here"
										id="floatingTextarea" name="bottom_text" style="height: 150px;">{{$data -> bottom_text}}</textarea>
									<label for="floatingTextarea">Bottom text</label>
								</div>
								<div class="form-floating mt-2">
									<textarea class="form-control" placeholder="Leave a comment here"
										id="floatingTextarea" name="bottom_text_ru" style="height: 150px;">{{$data -> bottom_text_ru}}</textarea>
									<label for="floatingTextarea">Bottom text RU</label>
								</div>
