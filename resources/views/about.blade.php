  ...
  <body>
    <div class="wrapper overflow-hidden">
      <header id="header" class="relative">
        ...
        <div
          class="header__content bg-center bg-[url('./project/image/bg-about.png')] bg-blend-darken md:mt-0 pt-32 pb-40 md:py-40 md:pb-50 text-white bg-no-repeat bg-cover"
        >
