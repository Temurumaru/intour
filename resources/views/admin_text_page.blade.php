				...
				<div class="row g-4">
					...
					<div class="col-sm-12 col-xl-6">
						<div class="bg-secondary rounded h-100 p-4">
							<form action="{{route('addTextPageC')}}" enctype="multipart/form-data" method="post">
								@csrf
								...
								<div class="form-floating mb-2">
									<textarea class="form-control" placeholder="Leave a comment here"
										id="floatingTextarea" name="text" maxlength="30000" style="height: 150px;"></textarea>
									<label for="floatingTextarea">Text</label>
								</div>

								<div class="form-floating mb-3">
									<textarea class="form-control" placeholder="Leave a comment here"
										id="floatingTextarea" name="text_ru" maxlength="32000" style="height: 150px;"></textarea>
